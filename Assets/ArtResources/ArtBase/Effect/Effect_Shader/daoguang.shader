...
////// Emissive:
                ...
                fixed4 finalRGBA = fixed4(lerp(sceneColor.rgb, finalColor,((i.vertexColor.a*(_Diffuse_var.a*(node_459+((node_459-lerp((node_2124_if_leA*node_7299)+(node_2124_if_leB*node_1623),node_1623,node_2124_if_leA*node_2124_if_leB))*_1_))))*_Alpha_var.b)),1);
