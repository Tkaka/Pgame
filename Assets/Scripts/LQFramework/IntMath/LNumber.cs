...
public struct LNumber : IComparable<LNumber>, IEquatable<LNumber>
{
    ...
    public const int INTEGER_BITS = sizeof(long) * 8 - FRACTION_BITS;          // 整数位位数 50

    public const int FRACTION_MASK = (int)(uint.MaxValue >> INTEGER_BITS);    // 2^14-1 = 16384-1 =16383 == 01111111111111
    public const int INTEGER_MASK = (int)(-1 & ~FRACTION_MASK);                    // -16384
    public const int FRACTION_RANGE = FRACTION_MASK + 1;                             // 16384 == 10000000000000

    //public const long Max = 562949953421312;     // 2^50 = 1125899906842624 - 1   2^49 = 1125899906842624 - 1
    public const long Max = 562949953421311;     // 2^50 = 1125899906842624 - 1   2^49 = 1125899906842624 - 1
    ...
    public static readonly LNumber two = 2;
    public static readonly LNumber three = 3;
    public static readonly LNumber four = 4;
    public static readonly LNumber five = 5;
    public static readonly LNumber six = 6;
    public static readonly LNumber seven = 7;
    public static readonly LNumber eight = 8;
    public static readonly LNumber nine = 9;
    public static readonly LNumber ten = 10;
    public static readonly LNumber hundred = 100;
    public static readonly LNumber Zero = new LNumber();

    public const int Muti_FACTOR = 16384;
    ...
    // int类型转换
    public static explicit operator int(LNumber number)
    {
        if (number.raw > 0)
            return (int)number.raw >> FRACTION_BITS;
        else
            return (int)(number.raw + FRACTION_MASK) >> FRACTION_BITS;
    }
